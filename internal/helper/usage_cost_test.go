...
func TestCalculateUsageTokenCostClaudePricingFallsBackToCachedTokens(t *testing.T) {
	pricing := entities.ModelPriceSetting{
		PricingStyle:            entities.ModelPricingStyleClaude,
...
func TestCalculateUsageTokenCostClaudePricingPrefersExplicitCacheFields(t *testing.T) {
	pricing := entities.ModelPriceSetting{
		PricingStyle:            entities.ModelPricingStyleClaude,
		PromptPricePer1M:        10,
		CompletionPricePer1M:    20,
